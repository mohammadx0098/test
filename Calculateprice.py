...
fixLoss = int(input(f'{Fore.YELLOW}>>> {Fore.RED}Please Enter your Fix Loss:\n{Fore.RED}').strip())

while True:

    inputValue = input(f'{Fore.YELLOW}>>> {Fore.GREEN} Please EnteryNumber, EntryPrices, SL :\n{Fore.RESET}')
    # os.system('cls')
